    ...
    <header>
        ...
        <div class="container-fluid">
          ...
          <div class="navbar-header">
            ...
            <a class="navbar-brand" href="<?= site_url('Admin/dashboard') ?>">Job Portal</a>
          </div>
          ...
          <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
            ...
            <ul class="nav navbar-nav navbar-right">
               <li><a href="<?= site_url('Admin/dashboard') ?>"><small><?=$this->session->userdata('username')?></small> Dashboard</a></li>
              <li><a href="<?= site_url('homecontroller/logout') ?>">Logout</a></li>
            </ul>
          </div><!-- /.navbar-collapse -->
        </div><!-- /.container-fluid -->
      </nav>
